...
export const WEAPONS = {
  fist:    { name: 'Fists',   icon: '✊', type: 'melee',  cat: 'melee',  reach: 4.5, dmg: 1, mine: 1, craftable: false },
  sword:   { name: 'Sword',   icon: '⚔️', type: 'melee',  cat: 'melee',  reach: 6.0, dmg: 6, mine: 2, craftable: true },
  axe:     { name: 'Axe',     icon: '🪓', type: 'melee',  cat: 'melee',  reach: 6.0, dmg: 4, mine: 4, craftable: true },
  pickaxe: { name: 'Pickaxe', icon: '⛏️', type: 'melee',  cat: 'melee',  reach: 5.5, dmg: 2, mine: 5, craftable: true },
  spear:   { name: 'Spear',   icon: '🔱', type: 'melee',  cat: 'melee',  reach: 7.0, dmg: 5, mine: 2, craftable: true },
